...
CONTEXT_LENGTHS = [512, 1024, 2048]  # Different context lengths to test
PATCH_SIZES = ["auto", 16, 32]       # Different patch sizes to test  
COMPRESSION_RATIOS = [0.25, 0.5, 0.75]  # Different compression ratios to test
...
def plot_comparison_results(all_results):
    ...
    # Save plot
    dataset_name = os.path.splitext(os.path.basename(CSV_PATH))[0]
    plot_path = f"results_prune_si_v2/{dataset_name}_comparison_plot.png"
